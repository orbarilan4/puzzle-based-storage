...
def main():
    ...
    print("the sum of the path lengths: "+ str(sum_of__path_lengths))
    print("the avg of developed states ever in open list: " + str(sum_of_developed_states / 100))
    print("the avg of close list: " + str(sum_of_close_lists / 100))
